...
import { Box, Button, Grid, Paper, Slider, Stack, TextField } from '@mui/material';
...
const header = ['Symbol', 'Open', 'High', 'Low', 'Close', 'Volume($)', 'Change(%)', 'Current Price($)', 'View', "SELL"];
...
const Portfolio = () => {
    ...
    const [symbols, setSymbols] = React.useState(["AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "JPM", "V", "NVDA", "BRK-A",
    ...
    useEffect(() => {
        ...
        const info = jwtDecode(refresh_token)
        setUser(info)
        const config = {
            headers: {
    ...
    return (
        <div className='center'>
            ...
            <Grid container style={{ padding: '2vw', display: 'flex', flexDirection: 'row' }}>
                ...
                {curBtn == 0 &&
                    <Grid item sx={12} sm={8} className='center' style={{ display: 'flex', flexDirection: 'column', marginRight: '20vw' }}>
                        <div><h1>Holdings</h1></div>
                        <DataTable data={table} />
                    </Grid>
                }
                {
                    curBtn == 1 &&
                    <Grid item sx={12} sm={8} className='center' style={{ marginTop: '5vw' }}>
                        <Chart
                            width={1000}
                            height={700}
                            chartType='LineChart'
                            ...
                            data={lineData}
                            options={{
                                title: `${symbol} Stock Price in USD($)`,
                                hAxis: {
                                    title: 'Date',
                                },
                                vAxis: {
                ...
                {
                    curBtn === 1 &&
                    <Grid item xs={12} sm={3} style={{ backgroundColor: 'pink', marginTop: '25vh', marginRight: '3vw', height: '70vh' }}>
